  ...
  head: () => ({
    meta: [
      ...
      { title: "Axon — AI Agent Usage Dashboard" },
      {
        name: "description",
        content:
          "Monitor AI agent runs, token spend, latency and error rates across your fleet in real time.",
      },
      { property: "og:title", content: "Axon — AI Agent Usage Dashboard" },
      {
        property: "og:description",
        content: "Monitor AI agent runs, token spend, latency and error rates in real time.",
      },
